...
*Please see the [advanced deployment](#advanced-deployment) section for details on setting up your own prerequisites and deploying the QuickStart with more control.*
...
- [Red Hat OpenShift DevSpaces](https://access.redhat.com/products/red-hat-openshift-dev-spaces): a container-based, in-browser development environment offered by Red Hat that facilitates cloud-native development directly within the OpenShift ecosystem. Included within the OpenShift product offering.
...
* **Description**: Optimize app development using the latest NVIDIA Nemotron models through Models-as-a-Service on your own private multi-tenant infrastructure in Red Hat AI.
